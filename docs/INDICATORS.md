...
set directly: **<!--indicator-count-->461<!--/indicator-count--> of them**, constructible by name from a config or at run
...
43 of the 504 indicators in `wickra-core` are not reachable from the terminal
