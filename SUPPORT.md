...
Thanks for using `wickra-terminal`. Here is where to go for help.
...
- Open a [GitHub Discussion](https://github.com/wickra-lib/wickra-terminal/discussions)
  for questions and ideas.

## Bugs and feature requests

Open a [GitHub issue](https://github.com/wickra-lib/wickra-terminal/issues) using
...
This terminal can connect to live markets and, once explicitly enabled, place
real orders that risk real capital. It is a research and engineering tool, not
financial advice, and comes with no warranty — run in paper mode and against
exchange testnets, and review the code before trading.
