...
[![Built on Wickra](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-terminal/built-on.svg)](https://github.com/wickra-lib/wickra)
...
[![Live demo](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-terminal/live-demo.svg)](https://live.wickra.org)
...
**0.1.8 — the current release.** The core, both renderers, all ten language
...
- **The boundary is data, not an API.** A config JSON in, a command JSON in, a
  frame JSON out. That is why <!--indicator-count-->497<!--/indicator-count--> indicators became reachable from ten languages
...
registry suite that constructs and drives all <!--indicator-count-->497<!--/indicator-count--> indicators, and a test that
