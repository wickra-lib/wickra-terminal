...
10. **README, badges, docs** — the banner and badge treatment, and the docs
    guides. ✅
11. **Indicators** — tick-to-OHLCV aggregation and a generated registry of <!--indicator-count-->457<!--/indicator-count-->
...
- **The remaining indicator families.** 47 of the 504 in `wickra-core` are not
